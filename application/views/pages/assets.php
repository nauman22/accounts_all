        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="insert_asset" id="form" name="form_cat"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="longitude" name="longitude" type="text" placeholder="Password" />
                                <label for="longitude">Map Longitude & Latitude</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" id="purchasing_date" name="purchasing_date" type="date" placeholder="Password" />
                                <label for="purchasing_date">Purchasing Date</label>
                            </div>
                             <div class="row align-items-center">
                                <div class="col ">
                                    <label for="inputGroupFile01">UPLOAD IMAGES (.jpg, .png allowed)</label> 
                                    <input multiple type="file" class="form-control" id="asset_img" name="asset_img[]">
                            ...
                            <br>
                            <div class="form-floating mb-3">
                                <input class="form-control" id="seller_name" name="seller_name" type="text" placeholder="Password" />
                                <label for="seller_name">Seller Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" id="seller_address" name="seller_address" type="text" placeholder="Password" />
                                <label for="seller_address">Seller Address</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" id="seller_cnic" name="seller_cnic" type="text" placeholder="Password" />
                                <label for="seller_cnic">Seller CNIC</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" id="seller_cell" name="seller_cell" type="text" placeholder="Password" />
                                <label for="seller_cell">Seller Cell</label>
                            </div>
...
<script type="text/javascript">
    $(document).ready( function () {
        ...
        var table =  $('#datatablesSimple').DataTable({
            ...
            responsive: true,
            "ajax":{
                "url": "<?php echo base_url()."asset_table" ?>",
                "dataType": "json",
                "type": "POST",
