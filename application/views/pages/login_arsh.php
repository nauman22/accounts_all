...
.social-login__icon:hover {
    ...
    <div class="screen">
        <div class="screen__content">
            <form class="login" action="login" id="form" name="form_cat" method="post" enctype="multipart/form-data">
                <div class="login__field">
                    <i class="login__icon fas fa-user"></i>
                    <input type="text" class="login__input"  name="email" required="required" id="inputEmail" type="email" placeholder="name@example.com">
                </div>
                <div class="login__field">
                    <i class="login__icon fas fa-lock"></i>
                    <input type="password" class="login__input" name="pwd" required="required"  id="inputPassword" type="password" placeholder="Password">
                </div>
