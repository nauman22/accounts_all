            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="insert_task" id="form" name="form_staff"  method="post" enctype="multipart/form-data">
                                <div class="form-floating mb-3">
                                    <select id="userid" name="userid" required="required" class="form-control" >
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12 col-md-12 col-xs-12 ">
                                        <div class="form-floating mb-3 col-xs-12">
                                            ...
                                            <input class="form-control" type="text" required id="heading" name="heading" placeholder="amount">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="father_name">Title</label>  
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-4 col-md-4 col-xs-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <input class="form-control" type="date" id="assign_date" name="assign_date" placeholder="amount">
                                            <label for="note">Assign Date</label>  
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <input class="form-control" type="date" id="completion_date" name="completion_date" placeholder="amount">
                                            <label for="note">Completion Date</label>  
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <input class="form-control" type="date" id="final_date" name="final_date" placeholder="amount">
                                            <label for="note">Final Date</label>  
                                ...
                                <div class="row align-items-center">
                                    <div class="col ">
                                        ...
                                        <input  type="file" class="form-control" id="task_img"  name="task_img[]">
